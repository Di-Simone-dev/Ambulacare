                ...
                <form action="#">
                    <div class="form-group">
                        <div class="col-9" id="elenco">
                            ...
                            <h3>Medico: {$esame.medico.nome}&ensp;&ensp;&ensp;Data Odierna: {$smarty.now|date_format:'%d/%m/%Y'}</h2>
				...
				<button class="bottonitab"><</button>
                            ...
                            <div>
                                <h4><label>Nuova Data :</label><input type="date" id="nuovadata" 
                                        ...
                                        {$esame.data}</label></h4>
                                <h4><label>Nuovo Orario : </label><input type="time" id="nuovoorario" name="nuovoorario" />
&ensp;&ensp;&ensp;&ensp;&ensp;<label>Vecchio Orario:
