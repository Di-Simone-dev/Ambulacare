...
1)COSTRUTTORE DELLA CLASSE FDataBase=__construct()
2)ACCESSO AL DB = getInstance() QUESTI DUE PER IL PATTERN SINGLETON
3)STORE DI UN ELEMENTO GENERICO SUL DB = storeDB(classe,oggetto)
4)LOAD DI UN ELEMENTO SINGOLO DAL DB = loadDB(classe,oggetto,id)
